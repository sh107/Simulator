...
public class Attack1 {
    ...
    public Attack1(String optionValue, String optionValue0, String ip, String pw) {
...
//        System.out.println(this.ip);
    ...
    public String readDatabaseQuery4() throws Exception {
        ...
        try {
            ...
            statement = connect.createStatement();
            // Result set get the result of the SQL query
            resultSet = statement.executeQuery("SELECT memory FROM `RedDragon`.`VMStatistics`");
    ...
    public String readDatabaseQuery5() throws Exception {
        ...
        try {
            ...
            statement = connect.createStatement();
            // Result set get the result of the SQL query
            resultSet = statement.executeQuery("select * from `RedDragon`.`logins`");
    ...
    public String readDatabaseQuery6() throws Exception {
        ...
        try {
            ...
            statement = connect.createStatement();
            // Result set get the result of the SQL query
            resultSet = statement.executeQuery("select * from `RedDragon`.`privateippool`");
    ...
    public String readDatabaseQuery7() throws Exception {
        ...
        try {
            ...
            statement = connect.createStatement();
            // Result set get the result of the SQL query
            resultSet = statement.executeQuery("select * from `RedDragon`.`Volume`");
    ...
    public String readDatabaseQuery8() throws Exception {
        ...
        try {
            ...
            statement = connect.createStatement();
            // Result set get the result of the SQL query
            resultSet = statement.executeQuery("select * from `RedDragon`.`ipusage`");
